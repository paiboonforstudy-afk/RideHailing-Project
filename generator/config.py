...
class RuntimeConfig:
    ...
    hot_province_chance: float = 0.60
    num_records: int = 1
...
TRIP_DISTANCE_CATEGORIES = [
    ...
    {"name": "ultra_long",  "min_km": 100,
        "max_km": 300,          "weight": 0.025},
    {"name": "extreme",     "min_km": 300,
        "max_km": 600,          "weight": 0.004},
    {"name": "outlier",     "min_km": 600,
        "max_km": float("inf"), "weight": 0.001},
]
