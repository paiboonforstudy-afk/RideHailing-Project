...
def _select_dropoff_province(pickup_province: dict) -> dict:
    ...
    The selection follows these target probabilities:
        - 70% chance: The same province as the pickup location.
        - 18% chance: A randomly selected popular province.
        - 12% chance: Any random province.
...
def generate_ride_record(config: RuntimeConfig = DEFAULT_CONFIG) -> dict:
    """
    ...
    - generating rider, driver, and vehicle details,
    ...
    Args:
        config (RuntimeConfig, optional):   Runtime configuration controlling simulation behavior 
                                            (e.g., completed_rate)
